    ...
    return (
        <form action={formAction} className="grid gap-3">
            ...
            <div className="space-y-1">
                ...
                <Input id="warehouse" name="warehouse" defaultValue={initialWarehouse}
            ...
            <div className="grid gap-3 rounded-lg border border-primary/10 p-3">
                ...
                <div className="flex items-center justify-between">
                    ...
                    <Switch name="notify_service" defaultChecked={initialNotifyService}
                            aria-label="Напоминания о сервисе"/>
                </div>
            </div>

            {message ? (
                <div
                    className="rounded-lg border border-primary/20 bg-primary/5 px-3 py-2 text-sm text-primary">{message}</div>
            ) : null}
