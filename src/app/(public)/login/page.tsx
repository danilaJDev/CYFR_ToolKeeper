...
export default async function LoginPage({
    ...
    return (
        <main
            className="min-h-screen grid place-items-center bg-gradient-to-br from-surface via-[#e6f0ff] to-white p-4">
            <div
                className="w-full max-w-5xl grid gap-6 rounded-3xl border border-primary/10 bg-white/70 shadow-xl backdrop-blur p-6 sm:p-8 lg:grid-cols-[1.2fr_1fr]">
                <div className="space-y-6">
                    <div className="space-y-2">
                        ...
                        <p className="text-sm text-muted-foreground">Единая база, прозрачные выдачи и напоминания о
                            сервисе.</p>
                    </div>
